...
int main()
{
    ...
    ofs.open("bundle_simulation4_24.csv");
    if (! ofs.is_open() ) {
    ...
    DVD_Bundling test(2000, .06, .005, 50, 3,  0.20, 501, p_val, TSIZE); //test is instance of DVD_Bundling clas
