...
public:
    ...
    double  comp_NPV();	 		    //Compute Net Present Value at t = 0	
...
private:
    ...
    double discount(int t);               i          				//This function computes the discount rate for each time value
};
